...
public class DiretorBox extends AbstractRequirementBoxDefinition {
    ...
    public RequirementBoxItemDataProvider getDataProvider(){
        return super.getDataProvider().addTask(FeriasFlow.Tasks.ANALISE_DIRETOR);
    }
    ...
    protected void configure(ItemBox itemBox) {
            itemBox
                    .name("Diretor")
                    .description("Aguardando análise diretor")
                    .icon(DefaultIcons.MONEY)
                    .evalPermission(true);
    }
